        ...
        "true" == document.querySelector("#js-scroll").getAttribute("data-horizontal") &&
            ...
            setTimeout(function () {
                ...
                e.on("scroll", function (t) {
                    var n = (2000 * t.scroll.y) / t.limit.y;
                    (e.el.style.backgroundColor = "hsl(".concat(n, ", 500%, 00%)")),
                        i.forEach(function (t) {
                            t.el.style.backgroundColor = "hsl(".concat(n, ", 300%, 50%)");
                        }),
                        s.forEach(function (t) {
                            t.el.style.color = "hsl(".concat(n, ", 100%, 8%)");
                        }),
